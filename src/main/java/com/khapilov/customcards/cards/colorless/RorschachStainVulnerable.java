 ...
 */
public class RorschachStainVulnerable extends RorschachStain {
    public static final String ID = "Rorschach:Vulnerable";
    ...
    public RorschachStainVulnerable() {
        super(ID, NAME, "cards/rorschachVulnerable.png", DESCRIPTION, CardType.SKILL, CardTarget.NONE);
    }
    ...
    public AbstractCard makeCopy() {
        return new RorschachStainVulnerable();
    }
